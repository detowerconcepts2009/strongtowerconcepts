...
export default function NECORegistrationPage() {
  return (
      ...
      <section className="bg-gradient-to-r from-blue-950 to-sky-700 px-6 py-20 text-white">
        <div className="mx-auto max-w-7xl">
          ...
          <h1 className="mt-4 text-4xl font-bold md:text-5xl">
            NECO Registration Services
          </h1>

          <p className="mt-6 max-w-3xl text-lg leading-8 text-blue-100">
            Get assistance with NECO registration, examination processing and
            related educational documentation through Strong Tower Concepts.
          </p>
      ...
      <section className="mx-auto max-w-7xl px-6 py-16">
        <div className="grid gap-10 lg:grid-cols-2">
          <div className="rounded-2xl bg-white p-8 shadow-sm">
            <h2 className="text-3xl font-bold text-blue-950">
              NECO Services Available
            </h2>

            <ul className="mt-6 space-y-4 text-gray-700">
              <li className="rounded-xl border p-4">
                NECO Registration Assistance
              </li>
              <li className="rounded-xl border p-4">
              ...
              <li className="rounded-xl border p-4">
                General NECO Registration Guidance
              </li>
            </ul>
          </div>
        ...
        <div className="mt-10 rounded-2xl bg-blue-50 p-8">
          <h2 className="text-2xl font-bold text-blue-950">
            Need NECO Assistance?
          </h2>

          <p className="mt-3 max-w-3xl leading-7 text-gray-600">
            Contact Strong Tower Concepts for assistance with your NECO
