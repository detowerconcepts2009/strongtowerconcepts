  ...
  return (
    ...
    <form className="space-y-12">
        ...
        <div className="mt-8 grid gap-6 md:grid-cols-2">
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                updateField("toilets", e.target.value)
              }
              placeholder="5"
              className="w-full rounded-xl border border-slate-300 px-4 py-3 outline-none focus:border-blue-900"
            />
            ...
            <div className="mt-6 grid gap-6 md:grid-cols-2">
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) =>
                    updateField("negotiable", e.target.value)
                  }
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) =>
                    updateField("titleDocument", e.target.value)
                  }
                  className="w-full rounded-xl border border-slate-300 px-4 py-3"
                >
            ...
            <div className="mt-6 grid gap-6 md:grid-cols-2">
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) =>
                    updateField("rentDuration", e.target.value)
                  }
                  className="w-full rounded-xl border border-slate-300 px-4 py-3"
                >
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    updateField("cautionFee", e.target.value)
                  }
                  className="w-full rounded-xl border border-slate-300 px-4 py-3"
                />
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    updateField("agencyFee", e.target.value)
                  }
                  className="w-full rounded-xl border border-slate-300 px-4 py-3"
                />
            ...
            <div className="mt-6 grid gap-6 md:grid-cols-2">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    updateField("minimumNights", e.target.value)
                  }
                  className="w-full rounded-xl border border-slate-300 px-4 py-3"
                />
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    updateField("maximumGuests", e.target.value)
                  }
                  className="w-full rounded-xl border border-slate-300 px-4 py-3"
                />
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    updateField("cleaningFee", e.target.value)
                  }
                  className="w-full rounded-xl border border-slate-300 px-4 py-3"
                />
      ...
      <div className="flex justify-end gap-4 border-t border-slate-200 pt-8">
        ...
        <button
          type="submit"
          className="rounded-xl bg-blue-900 px-8 py-3 font-medium text-white hover:bg-blue-800"
        >
          Continue
        </button>
