      ...
      <section className="bg-gradient-to-r from-blue-950 to-sky-700 px-6 py-20 text-white">
        <div className="mx-auto max-w-7xl">
          ...
          <p className="mt-6 max-w-3xl text-lg leading-8 text-blue-100">
            Reliable hosting solutions for business websites, web applications
      ...
      <section className="mx-auto max-w-7xl px-6 py-16">
        <div className="grid gap-10 lg:grid-cols-2">
          ...
          <div className="rounded-2xl bg-white p-8 shadow-sm">
            ...
            <ul className="mt-6 space-y-4 text-gray-700">
              <li className="rounded-xl border p-4">
                Domain name or preferred domain
              </li>
              <li className="rounded-xl border p-4">
                Website or application details
              </li>
              <li className="rounded-xl border p-4">
                Existing hosting information where applicable
              </li>
              <li className="rounded-xl border p-4">
                Required hosting specifications
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="mt-10 rounded-2xl bg-blue-50 p-8">
          ...
          <p className="mt-3 max-w-3xl leading-7 text-gray-600">
            Contact Strong Tower Concepts for hosting, domain and deployment
            assistance.
          </p>
